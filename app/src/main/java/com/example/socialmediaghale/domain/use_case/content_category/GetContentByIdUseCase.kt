...
class GetContentByIdUseCase @Inject constructor(private val repository: GetContentByIdRepo) {

    operator fun invoke(id: String): Flow<Resource<CategoryContentItem>> = flow {
